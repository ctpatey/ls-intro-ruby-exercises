...
# Alright, so I looked at the answer and my solution isn't specific enough. I didn't know I could write contact["Joe Smith"][:email] though. So written form hand the better answer is:
